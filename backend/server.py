...
@api_router.get("/pagespeed/history/{site_id}")
...
@api_router.get("/pagespeed/latest/{site_id}")
...
@api_router.get("/pagespeed/all-sites")
...
@api_router.post("/pagespeed/optimize/{site_id}")
